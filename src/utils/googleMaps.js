...
export const getNearbyStations = (lat, lng) => {
    ...
    const places = new maps.places.PlacesService(document.getElementById('dummy-map'))
...
export const getWalkingDirections = (originLatLngLiteral, destinationLatLngLiteral) => {
